...
const All = ({ lifeEvents = [], settings }) => {
  ...
  return (
    <div className="bg-slate-100">
      ...
      <div className="w-11/12 lg:w-9/12 mx-auto py-12 text-center">
        <h2 className="text-4xl lg:text-5xl text-slate-900 font-bold mb-4">
          {settings?.timeline_section_title || 'Life Timeline'}
        </h2>
        <p className="text-lg text-slate-600">
          {settings?.timeline_section_subtitle || 'A Journey Through Time'}
        </p>
      </div>
                ...
                <>
                  <div>
                    <div className="w-full relative">
                      <img className="w-full  min-h-[420px]" src={event.image || "/assets/life_events/default.png"} alt={event.title} />
                      {gallery.length > 0 && (
