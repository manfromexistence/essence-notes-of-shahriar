...
export default function CreateMenuItem({ parentOptions }: Props) {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        post("/admin/menu-items", {
            onSuccess: () => toast.success("Menu item created successfully"),
        });
    };
            ...
            <SidebarInset>
                ...
                <div className="container mx-auto py-8 px-4 max-w-2xl">
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-foreground">Create Menu Item</h1>
                        <p className="text-muted-foreground mt-2">Add a new navigation menu item</p>
                    </div>
